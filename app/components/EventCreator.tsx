...
export default function EventCreator() {
    ...
    const timePickOnConfirm = (fieldName: string) =>
...
const datePickOnChange = (fieldName: keyof FormValues) => (newDate: Date | undefined) => {
            if (newDate) {
...
return (
    <View style={styles.eventCreator}>
        ...
        {/* DevTool should be correctly placed and passed the control */}
